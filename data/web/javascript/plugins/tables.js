        ...
        if (action == 'before') {
          ...
          if (before_td) {
            if (before_td == map_td) {
              ...
              $(before_td).after('<' + before_td.tagName + '><br/></' + before_td.tagName + '>');
            } else {
              $(map_td).before('<' + map_td.tagName + '><br/></' + map_td.tagName + '>');
            }
          } else {
            $(map_td).before('<' + map_td.tagName + '><br/></' + map_td.tagName + '>');
          }
          ...
          if (after_td) {
            if (after_td == map_td) {
              ...
              $(after_td).before('<' + after_td.tagName + '><br/></' + after_td.tagName + '>');
            } else {
              $(map_td).after('<' + map_td.tagName + '><br/></' + map_td.tagName + '>');
            }
          } else {
            $(map_td).after('<' + map_td.tagName + '><br/></' + map_td.tagName + '>');
          }
